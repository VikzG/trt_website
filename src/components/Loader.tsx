...
const Loader = ({ finishLoading }: { finishLoading: () => void }) => {
  useEffect(() => {
    const timer = setTimeout(() => {
      finishLoading();
    }, 2500); // 2.5 secondes pour laisser l'animation respirer
  ...
  return (
    ...
    >
      {/* Animation d'onde circulaire en arrière-plan */}
      <motion.div
      ...
      <div className="relative overflow-hidden flex flex-col items-center">
        ...
        {/* Sous-titre avec animation de lettres */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Grain de film subtil pour le côté "Studio" */}
