          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
            ...
            <motion.div variants={textVariants} className="md:col-span-8">
              <p className="text-2xl md:text-4xl font-light leading-snug text-gray-200">
                Construire l’environnement sonore qui reflète avec fidélité<br/>les valeurs de votre marque. 
              </p>
            </motion.div>
          </div>

          {/* SECTION ARGUMENTAIRE (CORPS DU TEXTE) */}
          <div className="grid grid-cols-1 md:grid-cols-1 gap-12 mb-32">
            <motion.div variants={textVariants} className="md:col-start-1 md:col-span-7 space-y-12">
              <p className="text-lg md:text-xl text-white font-light leading-relaxed text-justify">
                Nous sommes persuadés que la musique est un moyen universel de créer une connexion profonde avec les autres.<br/>
                Par ce biais, nous pouvons communiquer nos sentiments et partager des expériences qui nous rassemblent.<br/> 
              ...
              <p className="text-lg md:text-xl text-white font-light leading-relaxed rounded-sm text-justify">
